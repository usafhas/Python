...
def setup():
    ...
    GPIO.setFunction(Forw, GPIO.OUT)
    GPIO.setFunction(Back, GPIO.OUT)
    GPIO.setFunction(rm, GPIO.OUT)
    GPIO.setFunction(lm, GPIO.OUT)
...
def destroy():
    ...
    GPIO.setFunction(Forw, GPIO.IN)
    GPIO.setFunction(Back, GPIO.IN)
    GPIO.setFunction(rm, GPIO.IN)
    GPIO.setFunction(lm, GPIO.IN)
