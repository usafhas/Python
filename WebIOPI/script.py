...
<head>
 ...
 var codesite_token = "ABZ6GAf5jblr1jbbvAKVCIbyTKE4Fn60Ig:1408055060286";
 
 
 var CS_env = {"projectName": "webiopi", "domainName": null, "token": "ABZ6GAf5jblr1jbbvAKVCIbyTKE4Fn60Ig:1408055060286", "relativeBaseUrl": "", "projectHomeUrl": "/p/webiopi", "profileUrl": "/u/106269983026589517018/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "usafhas@gmail.com"};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fwebiopi%2Fsource%2Fbrowse%2Ftrunk%2Fexamples%2Fservices%2Fcustom%2Fscript.py%3Fr%3D792" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed"><a href="/p/webiopi/source/browse/trunk/?r=792">trunk</a><span class="sp">/&nbsp;</span><a href="/p/webiopi/source/browse/trunk/examples/?r=792">examples</a><span class="sp">/&nbsp;</span><a href="/p/webiopi/source/browse/trunk/examples/services/?r=792">services</a><span class="sp">/&nbsp;</span><a href="/p/webiopi/source/browse/trunk/examples/services/custom/?r=792">custom</a><span class="sp">/&nbsp;</span>script.py</span>
...
><td class="source"># Macro definition part - Mapped to REST API         #<br></td></tr
><tr
id=sl_svn792_14
...
><td class="source"># A custom macro which prints out the arg received and return OK<br></td></tr
><tr
id=sl_svn792_16

><td class="source">@webiopi.macro<br></td></tr
><tr
id=sl_svn792_17

><td class="source">def myMacroWithArgs(arg1, arg2, arg3):<br></td></tr
><tr
id=sl_svn792_18

><td class="source">    webiopi.debug(&quot;myMacroWithArgs(%s, %s, %s)&quot; % (arg1, arg2, arg3))<br></td></tr
><tr
id=sl_svn792_19

><td class="source">    return &quot;OK&quot;<br></td></tr
><tr
id=sl_svn792_20
...
><td class="source"># A custom macro without args which return nothing<br></td></tr
><tr
id=sl_svn792_22
...
><td class="source">def myMacroWithoutArgs():<br></td></tr
><tr
id=sl_svn792_24

><td class="source">    webiopi.debug(&quot;myMacroWithoutArgs()&quot;)<br></td></tr
><tr
id=sl_svn792_25
...
><td class="source"># Loop execution part - WebIOPi will call loop()     #<br></td></tr
><tr
id=sl_svn792_43
...
><td class="source"># Example loop which toggle RELAY each 5 seconds<br></td></tr
><tr
id=sl_svn792_45

><td class="source">def loop():<br></td></tr
><tr
id=sl_svn792_46

><td class="source">    GPIO.output(RELAY, not GPIO.input(RELAY))<br></td></tr
><tr
id=sl_svn792_47

><td class="source">    webiopi.sleep(5)        <br></td></tr
><tr
id=sl_svn792_48
...
<script type="text/javascript">
 ...
 by tro...@trouch.com
 on Jan 29, 2013
 &nbsp; <a href="/p/webiopi/source/diff?spec=svn792&r=792&amp;format=side&amp;path=/trunk/examples/services/custom/script.py&amp;old_path=/trunk/examples/services/custom/script.py&amp;old=">Diff</a>
 </div>
...
functionalities</pre>
 ...
 var selected_path = '/trunk/examples/services/custom/script.py';
 ...
 <a href="/p/webiopi/source/list?path=/trunk/examples/services/custom/script.py&start=792">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//webiopi.googlecode.com/svn-history/r792/trunk/examples/services/custom/script.py">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn792': '/trunk/examples/services/custom/script.py'}
 codereviews = CR_controller.setup(
 {"projectName": "webiopi", "domainName": null, "token": "ABZ6GAf5jblr1jbbvAKVCIbyTKE4Fn60Ig:1408055060286", "relativeBaseUrl": "", "projectHomeUrl": "/p/webiopi", "profileUrl": "/u/106269983026589517018/", "assetVersionPath": "https://ssl.gstatic.com/codesite/ph/13997016681179179006", "assetHostPath": "https://ssl.gstatic.com/codesite/ph", "loggedInUserEmail": "usafhas@gmail.com"}, '', 'svn792', paths,
